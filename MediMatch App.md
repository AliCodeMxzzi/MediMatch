...
- `google/gemma-3-4b-it` — **Gemma 3 4B Instruct** (useCase: `vision`, tags: text-generation, image-to-text, automatic-speech-recognition, summarization, translation, math, question-answering)
